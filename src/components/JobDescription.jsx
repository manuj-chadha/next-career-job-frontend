  ...
  return (
    ...
    <div className="max-w-5xl mx-auto my-12 max-sm:my-6 px-6">
      ...
      <div className="bg-white p-6 md:p-10 rounded-xl shadow-xl space-y-6">
        ...
        {/* Job Details */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-md  max-sm:text-sm max-sm:gap-2 text-gray-800">
        ...
        <div className="space-y-4 mt-6">
          <div>
            <h2 className="text-lg max-sm:text-md font-bold text-gray-900 mb-1">Job Description</h2>
            <p className="text-md max-sm:text-sm leading-relaxed text-gray-700">{singleJob?.description}</p>
          </div>
          <div>
            <h2 className="text-lg font-bold text-gray-900 max-sm:text-md mb-1">Requirements</h2>
            <ul className="list-disc list-inside text-md max-sm:text-sm text-gray-700 space-y-1">
