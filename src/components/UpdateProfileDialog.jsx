...
const UpdateProfileDialog = ({ open, setOpen }) => {
    ...
    const submitHandler = async (e) => {
        ...
        if (input.resume instanceof File) {
            ...
            formData.append("resumeUrl", input.resumeUrl); // If it's a URL
        }
        try {
            setLoading(true);
    ...
    return (
        <div>
            <Dialog open={open}>
                <DialogContent aria-describedby="profile-dialog-description" className="sm:max-w-[425px]" onInteractOutside={() => setOpen(false)}>
                    <DialogHeader>
