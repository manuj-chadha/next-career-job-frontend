  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        ...
        <Button className='bg-white/60 cursor-pointer text-black rounded-md hover:bg-white/50'><img src="https://img.clerk.com/static/google.svg?width=80" alt="Google" /><span>Google</span></Button>
      </DialogTrigger>
